...
```html
<script src="https://cdn.jsdelivr.net/npm/fuse.js@7.0.1"></script>
```
...
```html
<script type="module">
  import Fuse from 'https://cdn.jsdelivr.net/npm/fuse.js@7.0.1/dist/fuse.mjs'
</script>
```
...
```typescript
// @deno-types="https://deno.land/x/fuse@v7.0.1/dist/fuse.d.ts"
import Fuse from 'https://deno.land/x/fuse@v7.0.1/dist/fuse.min.mjs'
```
